...
of elasticsearch-py licensed under the [Apache v2.0 License](LICENSE.txt). 
...
To get started with the OpenSearch Python Client, see [User Guide](USER_GUIDE.md). This repository also contains [working samples](https://github.com/opensearch-project/opensearch-py/tree/main/samples) and [benchmarks](https://github.com/opensearch-project/opensearch-py/tree/main/benchmarks).
...
[Apache v2.0 License](LICENSE.txt).

## Copyright

Copyright OpenSearch Contributors. See 
[NOTICE](NOTICE.txt) for details.
